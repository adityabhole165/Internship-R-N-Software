        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 content">
            <div class="title-actions">
                ...
                <div class="d-flex align-items-center">
                    <a href="form.php" class="btn btn-primary new-form-btn mt-2">Add New Employee</a>
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                $page_url = "display.php?page=" . $i . "&showTable=1";
                echo "<li class='page-item" . $active_class . "'>";
                echo "<a class='page-link' href='" . $page_url . "'>" . $i . "</a>";
                echo "</li>";
            }
            echo "</ul></nav>";
...
<script>
    $(document).ready(function() {
        ...
        $('#employeeLink').click(function(event) {
            event.preventDefault();
             $('.table-container').toggle();
            const isVisible = $('.table-container').is(':visible');
            const currentUrl = window.location.href.split('?')[0];
            const newUrl = currentUrl + '?showTable=' + (isVisible ? '1' : '0');
