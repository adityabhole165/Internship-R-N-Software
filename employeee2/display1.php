    ...
    <div class="row">
        ...
        <nav class="col-md-3 col-lg-2 sidebar design">
            ...
            <ul class="nav flex-column mt-4">
                <li class="nav-item">
                   <span> <a class="nav-link col-6" href="display.php" style="background-color: #dee2e6;">Home</a> </span>
                </li>
                <li class="nav-item">
                    <span><a class="nav-link col-6 mt-2" id="employeeLink" href="#" style="background-color: #dee2e6;">Employee</a></span>
                </li>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <form method='POST' action='edit.php' style='display:inline;'>
                            <input type='hidden' name='id' value='".$row['SR Name']."'>
                        ...
                        <form method='POST' action='delete.php' style='display:inline;' onsubmit='return confirmDelete()'>
                              ...
                              </td>";  // Add Update and Delete buttons
                        echo "</tr>";
